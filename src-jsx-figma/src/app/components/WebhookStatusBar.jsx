    ...
    >
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0">
        ...
        <span className="text-emerald-600">
          Last update: <span className="text-emerald-700">{lastUpdateText}</span>
        </span>
      </div>
      ...
      {/* Webhook Badge with hover popover */}
      <div
      ...
      <button
        ...
        className="ml-1 p-1 text-emerald-400 hover:text-emerald-600 hover:bg-emerald-100 rounded transition-colors flex-shrink-0"
        title="Dismiss"
      >
        <X size={12} />
      </button>
